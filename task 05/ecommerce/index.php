...
$product = new product;
$brand = new Brand;
$brandStmt = $brand->all()->get_result();
$recentpro = $product->recentproduct()->get_result();
...
<div class="product-area bg-image-1 pt-100 pb-95">
    <div class="container">
        <div class="row">
            <?php
            if ($brandStmt->num_rows >= 1) {
                foreach ($brandStmt->fetch_all(MYSQLI_ASSOC) as $brand) { ?>
                    <div class="col-2">
...
<div class="product-area gray-bg pt-90 pb-65">
    <div class="container">
        ...
        <?php
if ($recentpro->num_rows >= 1) {
    foreach ($recentpro->fetch_all(MYSQLI_ASSOC) as $product) { ?>
        <div class="col-2">
            <div class="product-img">
                <a href="#">
                    <img alt="<?=  $product['name_en'] ?>" src="assets/img/products/<?=  $product['image'] ?>">
                </a>
            </div>
            <div class="product-content text-left">
                <div class="product-hover-style">
